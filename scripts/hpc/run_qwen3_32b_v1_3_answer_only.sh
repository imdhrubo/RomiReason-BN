...
#SBATCH --job-name=rrbn-qwen32-v13
#SBATCH --output=slurm-rrbn-qwen32-v13-%j.out
#SBATCH --error=slurm-rrbn-qwen32-v13-%j.err
set -euo pipefail
...
python scripts/hpc/run_vllm_jsonl.py --jobs data/evaluation/primary_v1_3_answer_only_inference_inputs/qwen3-32b.jsonl --shard-size 500 --all-shards --output-dir "$RESULTS_ROOT/primary_v1_3_answer_only/qwen3-32b/responses" --event-dir "$RESULTS_ROOT/primary_v1_3_answer_only/qwen3-32b/events" --tensor-parallel-size 2 --dtype bfloat16
