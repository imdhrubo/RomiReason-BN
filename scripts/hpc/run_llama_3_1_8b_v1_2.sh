...
#SBATCH --job-name=rrbn-llama8-v12
#SBATCH --output=slurm-rrbn-llama8-v12-%j.out
#SBATCH --error=slurm-rrbn-llama8-v12-%j.err
...
python scripts/hpc/run_vllm_jsonl.py \
  --jobs data/evaluation/primary_v1_2_inference_inputs/llama-3-1-8b-instruct.jsonl \
  --shard-size 500 --all-shards \
  --output-dir "$RESULTS_ROOT/primary_v1_2/llama-3-1-8b-instruct/responses" \
  --event-dir "$RESULTS_ROOT/primary_v1_2/llama-3-1-8b-instruct/events" \
