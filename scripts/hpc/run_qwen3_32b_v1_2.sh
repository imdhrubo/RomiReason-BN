...
#SBATCH --job-name=rrbn-qwen32-v12
#SBATCH --output=slurm-rrbn-qwen32-v12-%j.out
#SBATCH --error=slurm-rrbn-qwen32-v12-%j.err
...
python scripts/hpc/run_vllm_jsonl.py \
  --jobs data/evaluation/primary_v1_2_inference_inputs/qwen3-32b.jsonl \
  --shard-size 500 --all-shards \
  --output-dir "$RESULTS_ROOT/primary_v1_2/qwen3-32b/responses" \
  --event-dir "$RESULTS_ROOT/primary_v1_2/qwen3-32b/events" \
